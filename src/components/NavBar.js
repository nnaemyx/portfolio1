    ...
    >
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        <nav className="flex items-center justify-center flex-wrap">
          ...
          <motion.a
            href="https://www.linkedin.com/in/edeh-johnpaul-1924611ab/"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className="w-6 mx-3"
            target={"_blank"}
...

      {
        ...
        className="min-w-[70vw] z-30 flex flex-col justify-between bg-dark/90 dark:bg-light/75 rounded-lg
      ...
      <div className="absolute sm:left-[35%] left-[50%] top-2 translate-x-[50%]">
        <Logo />
      </div>
    </header>
  );
